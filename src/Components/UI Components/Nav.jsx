            ...
            <Navbar expand="lg" bg="white" variant="light" className="shadow-sm py-3 py-lg-0 px-3 px-lg-0" expanded={expanded}>
                ...
                <Navbar.Collapse id="navbarCollapse">
                    <Nav className="ms-auto py-0">
                        <Nav.Link as={Link} to="/" onClick={closeNav} className={`fw-semibold nav-link ${isNavLinkActive('/') ? 'active' : ''}`}>Home</Nav.Link>
                        <Nav.Link as={Link} to="/About" onClick={closeNav} className={`nav-link ${isNavLinkActive('/About') ? 'active' : ''}`}>About</Nav.Link>
                        <Nav.Link as={Link} to="/Services" onClick={closeNav} className={`nav-link ${isNavLinkActive('/Services') ? 'active' : ''}`}>Services</Nav.Link>
                        <Nav.Link as={Link} to="/Contact" onClick={closeNav} className={`nav-link ${isNavLinkActive('/Contact') ? 'active' : ''}`}>Contact</Nav.Link>
